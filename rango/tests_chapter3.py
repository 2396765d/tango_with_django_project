...
_WebResourceTextEncodingName^WebResourceURL_WebResourceFrameName_WebResourceData_WebResourceMIMETypeUUTF-8_mhttps://raw.githubusercontent.com/maxwelld90/tango_with_django_2_code/master/progress_tests/tests_chapter3.pyPO&<html><head></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;"># 
...
class Chapter3AboutPageTests(TestCase):
    ...
    def test_for_index_hyperlink(self):
        ...
        self.assertTrue(single_quotes_check or double_quotes_check, f"{FAILURE_HEADER}We could not find a hyperlink back to the index page in your about view. Check your about.html template, and try again.{FAILURE_FOOTER}")</pre></body></html>Ztext/plain    ( F U l ~ î ö
'*                           '5